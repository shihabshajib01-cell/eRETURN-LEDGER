  ...
  return (
    <section className="mx-auto w-full max-w-[1320px] space-y-4" aria-labelledby="salary-ibas-title">
      <header>
        ...
        <p className="mt-1 text-sm leading-relaxed text-[#5F6B7A] max-w-3xl">
          {isBn
      ...
      <section className="overflow-hidden rounded-xl border border-[#E2E8F0] bg-white" aria-labelledby="salary-info-title">
        <div className="border-b border-[#E2E8F0] px-5 py-3.5 bg-slate-50/50">
      ...
      <section className="overflow-hidden rounded-xl border border-[#E2E8F0] bg-white" aria-labelledby="tds-claim-title">
        ...
        <div className="flex justify-end border-t border-[#E2E8F0] bg-slate-50/50 px-5 py-3.5">
          <button
            type="button"
